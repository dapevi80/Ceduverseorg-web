...
function SimuladorComisiones() {
  ...
  const tiposSocio = {
    ...
    agente: { label: "Agente", pct: 0.15, dc3Pct: 0.40, sepPct: 0.10, referral: 500, duracion: "24 meses" },
                ...
                <div className="space-y-5">
                  <div>
                    ...
                    <p className="text-[11px] text-gray-500 mt-2 leading-relaxed" data-testid="text-tipo-desc">
                      ...
                      {tipoSocio === "agente" && "Capacita e imparte cursos. Ganas 15% del fee + 40% DC-3 + 10% SEP + $500/referido por 24 meses."}
            ...
            <table className="w-full text-sm" data-testid="table-perfiles">
              ...
              <tbody className="bg-white">
                {[
                  ...
                  ["Agente", "15% del fee", "40%", "10%", "$500", "24 meses"],
