    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          "El diseño prevé que la wallet del proyecto ancle el hash ('la entidad actúa') y que la wallet madre de BrainShield contrafirme el mismo hash ('el originador ratifica'), todo en Base. Hoy operan Base y la atestación SHA-256; el doble sello y el NFT del certificado NO están en operación: son diseño",
        ...
        correctIndex: 1,
        explanation: "El doble sello Opción A prevé anclar un mismo hash canónico dos veces en la red Base: primero la wallet del proyecto (Ceduverse), y luego la wallet madre de BrainShield, que contrafirmaría por referencia a la tx del proyecto (mismo valor probatorio, ~mitad de gas). Eso daría una doble cadena de custodia verificable por cualquiera. Estado real: la red Base y el mecanismo de atestación por hash SHA-256 existen y operan; el doble sello NO opera todavía —la wallet de proyecto de Ceduverse aún no está constituida; solo existe la wallet madre de BrainShield— y el NFT gemelo del certificado NO está acuñado ni desplegado: es diseño, igual que todos los tokens del consorcio (CEDU incluido). Explícalo siempre como diseño, nunca como algo que un socio pueda tener hoy.",
      },
      {
